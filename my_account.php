...
<body>
	...
	<div class="main_wrapper">
		...
		<!-- footer Start -->
		<div class="footer">
		<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif">&copy; 2021 all rights reserved | Developed By: <a>Houssem Dimassi</a></h5>
		</div>
		<!-- Footer End -->
