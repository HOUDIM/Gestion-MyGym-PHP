...
<body bgcolor="#999999">
	<form method="post" action="" enctype="multipart/form-data">
		<table width="794px" align="center" border="1" bgcolor="#f1533e">
			<tr>
				<td colspan="2" align="center"><h1>Mettre à jour ou modifier les formateurs</h1></td>
			</tr>
			<tr>
				<td align="right"><b>Nom du formateur</b></td>
				<td><input type="text" name="trainer_name" value="<?php echo $tran_name; ?>"></td>
			</tr>
			<tr>
				<td align="right"><b>Classe</b></td>
				<td>
			...
			<tr>
				<td align="right"><b>Contact formateur</b></td>
				<td><input type="text" name="trainer_contact" value="<?php echo $tran_contact; ?>"></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" name="update_trainer" value="Mettre A jour"></td>
			</tr>
		</table>
	</form>
</body>
...
<?php 
	...
	if (isset($_POST['update_trainer']))
	{
		...
		elseif ($tran_contact=='') {
			...
			if ($run_update) {
				echo "<script>alert('Formateur A ete Mis A jour')</script>";
