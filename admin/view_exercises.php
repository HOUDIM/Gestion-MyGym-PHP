...
<body>
	...
	<table align="center" width="794" style="color:white;">
		<tr align="center">
			<td colspan="6"><h2>Tous Les Exercices</h2><br></td>
		</tr>
		<tr>
			<th>Numero : </th>
			<th>Nom : </th>
		...
		<tr align="center">
			...
			<td><a href="index.php?edit_exercise=<?php echo $exer_id; ?>">Modifier</a></td>
			<td><a href="index.php?delete_exercise=<?php echo $exer_id; ?>">Supprimer</a></td>
		</tr>
		<?php } ?>
	</table>
	<?php } ?>
