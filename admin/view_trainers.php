...
<body>
	...
	<table align="center" width="794" style="color:white;">
		<tr align="center">
			<td colspan="6"><h2>Tous Les Entreneurs</h2><br></td>
		</tr>
		<tr>
			<th>Numero : </th>
			<th>Nom : </th>
		...
		<tr align="center">
			...
			<td><a href="index.php?edit_tran=<?php echo $tran_id; ?>">Modifier</a></td>
			<td><a href="index.php?delete_tran=<?php echo $tran_id; ?>">Supprimer</a></td>
		</tr>
		<?php } ?>
	</table>
	<?php }
