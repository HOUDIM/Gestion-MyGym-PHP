	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			<div class="right" style="background-image: url(images/right.jpg)">
					...
					<a href="index.php?view_trainers">Voir Entreneurs</a>
					<a href="index.php?add_trainers">Ajouter Entreneurs</a>
					<a href="index.php?view_exercises">Voir Exercices</a>
					<a href="index.php?add_exercises">Ajouter Exercises</a>
