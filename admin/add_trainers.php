...
<body bgcolor="#999999">
	<form method="post" action="add_trainers.php" enctype="multipart/form-data">
		<table width="794px" align="center" border="1" bgcolor="#f1533e">
			<tr>
				<td colspan="2" align="center"><h1>Ajouter un nouveau formateur</h1></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" name="add_trainer" value="Ajouter Entreneur"></td>
			</tr>
		</table>
	</form>
</body>
