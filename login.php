...
<body>
	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			<div id="left_sidebar">
				<div id="sidebar_title">Jours</div>
				<ul id="days">
					<?php  
						getDays();
					?>
			...
			<div id="right_content">
				<div id="headline">
					...
					<div id="products_box" style="background-image: url(images/bg1.jpg)">
						<div id="frm">
								<h2 style="color:darkgrey; text-align: center;">Connexion</h2>
								<form action="login.php" method="post">
								    <label for="fname">Adresse Email</label>
								    <input type="email" id="fname" name="user_email" placeholder="Votre Prenom">
								    <label for="lname">Mot de passe</label>
								    <input type="password" id="lname" name="user_pass" placeholder="Votre Nom">
								    <input type="submit" value="confirmer" name="user_login">
								</form>
						</div>
					</div>
